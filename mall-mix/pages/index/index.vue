	...
	export default {
		...
		methods: {
			...
			toGoods(item) {
				...
				uni.navigateTo({
					url: `/pages/product/product?id=1&co_id=${item.co_id}`
				});
			},
			//轮播图指示器
			swiperChange(event) {
